#ifndef BOOST_SAFE_FLOAT_POLICY_CHECK_ADDITION_UNDERFLOW_HPP
#define BOOST_SAFE_FLOAT_POLICY_CHECK_ADDITION_UNDERFLOW_HPP
...
#endif // BOOST_SAFE_FLOAT_POLICY_CHECK_ADDITION_UNDERFLOW_HPP
